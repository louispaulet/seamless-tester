...
2. Click `Select image` and choose a texture or image.
3. Use `-` and `+` to adjust tile size.
4. Look closely at the edges where neighboring tiles meet.

## Current State
- Single-file HTML prototype.
- No build step and no runtime dependencies.
- Includes an embedded default texture so the page works immediately.
